...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema musicStreamingSchema) {
    ...
    @Bean
    public XsdSchema musicStreamingSchema() {
        return new SimpleXsdSchema(new ClassPathResource("xsd/music-streaming.xsd"));
    }
}
